...
//-----------------------------------------------------------------------------
// void OptimizeFaces(const uint32_t* indexList, uint32_t indexCount, uint32_t vertexCount, uint32_t* newIndexList, uint32_t lruCacheSize);
...
inline float FindVertexCacheScore(uint32_t cachePosition, uint32_t maxSizeVertexCache) { return s_vertexCacheScores[maxSizeVertexCache][cachePosition]; }

inline float FindVertexValenceScore(uint32_t numActiveTris) { return s_vertexValenceScores[numActiveTris]; }
